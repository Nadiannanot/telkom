                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        <li class="breadcrumb-item">
                            <a href="<?= base_url('userseqclose'); ?>">Home</a>
                        </li>
    ...
    <div class="main-content col ps-0">
        <div class="p-2 pt-0">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-3">
                <!-- Search form -->
                <form method="get" action="<?= base_url('userseqclose'); ?>" class="d-flex align-items-center" style="gap: 8px;">
                                        ...
                                        <?php if (!empty($seqclose)) : ?>
                                            ...
                                            foreach ($seqclose as $s) : ?>
                                                <tr class="text-center align-middle">
                                                    ...
                                                    <td><?= $s->sub_segment; ?></td>
                                                    <td>
                                                        <a href="<?= base_url('userseqclose/edit/' . $s->id); ?>" class="btn btn-warning btn-sm">Edit</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        <?php else : ?>
