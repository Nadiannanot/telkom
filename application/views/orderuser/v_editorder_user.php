            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url('orderuser'); ?>">Order</a></li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form method="post" action="<?= base_url('orderuser/update'); ?>">
                                <input type="hidden" name="id" value="<?= $order->id ?>">
                                <div class="mb-3">
                                    <label class="form-label">No Ticket</label>
                                    <input type="text" name="no_ticket" class="form-control" value="<?= set_value('no_ticket', $order->no_ticket) ?>" readonly>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" name="reported_date" class="form-control" value="<?= set_value('reported_date', date('Y-m-d\TH:i', strtotime($order->reported_date))) ?>">
                                    <span class="text-danger"><?= form_error('reported_date'); ?></span>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Closed Date</label>
                                    <input type="datetime-local" name="closed_date" class="form-control" value="<?= set_value('closed_date', date('Y-m-d\TH:i', strtotime($order->closed_date))) ?>">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nama_teknisi" class="form-control" value="<?= set_value('nama_teknisi', $order->nama_teknisi) ?>">
                                ...
                                <a href="<?= base_url('orderuser'); ?>" class="btn btn-secondary">Kembali</a>
                            </form>
                            <?= validation_errors() ?>
                        </div>
                    </div>
