        ...
        <div class="p-2 pt-0">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-3">
                ...
                <div class="d-flex flex-wrap align-items-center gap-3 mb-3">
                    <a href="<?= base_url('menu/add'); ?>" class="btn btn-primary" style="margin-right: 10px;">
                                                ...
                                                <tr class="text-center align-middle">
                                                    ...
                                                    <td>
                                                        <div class="d-inline-flex gap-1">
                                                            ...
                                                            <a href="<?= base_url('menu/delete/' . $m['id']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Hapus menu ini?')">Hapus</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
