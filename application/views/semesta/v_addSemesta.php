			...
			<div class="row">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-end">
						...
						<li class="breadcrumb-item active" aria-current="page">Add Semesta</li>
					</ol>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="card mb-4">
						...
						<div class="card-body">
							<form action="<?= base_url('semesta/postAdd'); ?>" method="POST">
								...
								<div class="mb-3">
									...
									<input type="text" name="s_node_id_ip" class="form-control" value="<?= set_value('s_node_id_ip'); ?>" autocomplete="off">
									<span class="text-danger"><?= form_error('s_node_id_ip'); ?></span>
								</div>

								<div class="mb-3">
									<label class="form-label">Shelf / Slot / Port ONU</label>
									<input type="text" name="s_shelf_slot_port_onu" class="form-control" value="<?= set_value('s_shelf_slot_port_onu'); ?>" autocomplete="off">
									<span class="text-danger"><?= form_error('s_shelf_slot_port_onu'); ?></span>
								</div>

								<div class="mb-3">
									<label class="form-label">Fiber Length</label>
									<input type="text" name="s_fiber_lenght" class="form-control" value="<?= set_value('s_fiber_lenght'); ?>" autocomplete="off">
								...
								<div class="mb-3">
									...
									<input type="text" name="s_odc" class="form-control" value="<?= set_value('s_odc'); ?>" autocomplete="off">
									<span class="text-danger"><?= form_error('s_odc'); ?></span>
								</div>

								<div class="mb-3">
									<label class="form-label">ODP</label>
									<input type="text" name="s_odp" class="form-control" value="<?= set_value('s_odp'); ?>" autocomplete="off">
