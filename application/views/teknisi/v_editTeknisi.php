			...
			<div class="card card-primary">
				...
				<div class="card-body">
					<form action="<?= base_url('teknisi/update'); ?>" method="post">
						...
						<!-- Hidden untuk NIK lama (jika berubah) -->
						...
						<div class="form-group">
							...
							<select name="jenis" id="jenis" class="form-control">
								...
								<option value="IOAN" <?= set_select('jenis', 'IOAN', $teknisi->jenis == 'IOAN'); ?>>IOAN</option>
								<option value="BANTEK" <?= set_select('jenis', 'BANTEK', $teknisi->jenis == 'BANTEK'); ?>>BANTEK</option>
								<option value="MAINTENANCE" <?= set_select('jenis', 'MAINTENANCE', $teknisi->jenis == 'MAINTENANCE'); ?>>MAINTENANCE</option>
								<option value="PROVISIONING" <?= set_select('jenis', 'PROVISIONING', $teknisi->jenis == 'PROVISIONING'); ?>>PROVISIONING</option>
							</select>
