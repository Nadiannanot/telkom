	...
	<div class="app-content">
		<div class="container-fluid">
			<div class="card card-primary">
				<div class="card-header">Form Tambah Teknisi</div>
				<div class="card-body">
					<form action="<?= base_url('teknisi/postAdd'); ?>" method="post">
						<div class="form-group">
							<label for="nik_teknisi">NIK</label>
							<input type="text" name="nik_teknisi" class="form-control" id="nik_teknisi" value="<?= set_value('nik_teknisi'); ?>">
							<small class="text-danger"><?= form_error('nik_teknisi'); ?></small>
						</div>
						<div class="form-group">
							<label for="nama_teknisi">Nama</label>
							<input type="text" name="nama_teknisi" class="form-control" id="nama_teknisi" value="<?= set_value('nama_teknisi'); ?>">
