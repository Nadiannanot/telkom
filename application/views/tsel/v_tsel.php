<main class="app-main">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Data TSEL</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="main-content col ps-0">
        <div class="p-2 pt-0">
            <h1 class="mb-2">Data TSEL</h1>

            <!--begin::Top Actions-->
            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-3">
                <!-- Search form -->
                <form method="get" action="<?= base_url('tsel'); ?>" class="d-flex align-items-center" style="gap: 8px;">
                ...
                <div class="d-flex flex-wrap align-items-center gap-3 mb-3">
                    <a href="<?= base_url('tsel/add'); ?>" class="btn btn-primary" style="margin-right: 10px;">
                        <i class="fas fa-plus-circle"></i> Tambah
                    </a>

                    <form action="<?= base_url('tsel/uploadCsv'); ?>" method="post" enctype="multipart/form-data" class="d-flex flex-wrap gap-2 align-items-center">
                                                ...
                                                <tr class="text-center align-middle">
                                                    ...
                                                    <td>
                                                        <div class="d-inline-flex gap-1">
                                                            <a href="<?= base_url('tsel/edit/' . $row->id); ?>" class="btn btn-warning btn-sm">Edit</a>
                                                            <a href="#" data-href="<?= base_url('tsel/delete/' . $row->id); ?>" class="btn btn-danger btn-sm tombol-hapus">Hapus</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
