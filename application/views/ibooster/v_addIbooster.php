			...
			<div class="row">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-end">
						...
						<li class="breadcrumb-item active" aria-current="page">Add Ibooster</li>
					</ol>
				</div>
			</div>
		</div>
							...
							<form action="<?= base_url('ibooster/postAdd'); ?>" method="POST">
								...
								foreach ($fields as $name => $label) : ?>
									<div class="mb-3">
										...
										<input type="text" name="<?= $name; ?>" class="form-control" value="<?= set_value($name); ?>" autocomplete="off" required>
